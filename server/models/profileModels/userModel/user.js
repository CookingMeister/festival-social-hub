...
const userSchema = new Schema({
  ...
  socials: { type: Map, of: String }, // Social media links (e.g., Facebook, Twitter, etc.)
  aboutMe: { type: String }, // About me section
  topFestivals: [{ type: String }], // Top 3 festivals attended by the user
});
